...
\begin{datecvsection}{Positions}
		...
		2020– & Chargé de recherche dans l’équipe \placeName{Spades}, à l’\placeName{Inria} \placeName{Grenoble}—\placeName{Alpes}. \\
...
\begin{itemize}
   ...
   \item Notions d’espagnol,
\end{itemize}}
\parbox{.5\textwidth}{
\begin{itemize}
   \item Très bon niveau d’anglais,
...
\begin{datecvsection}{Conférences}
	...
	2021 & Conrad~\familyName{Watt}, Xiaojia~\familyName{Rao}, Jean~\familyName{Pichon-Pharabod}, Martin~\familyName{Bodin}, et Philippa~\familyName{Gardner}, \textit{Two Mechanisations of WebAssembly 1.0}. FM. \\
...
\begin{datecvsection}{Colloques}
	...
	2026 & Timothé~\familyName{Baleras}, Martin~\familyName{Bodin}, et Ugo~\familyName{Comignani}, \textit{COSMetyc : OpenStreetMap en OCaml}. Aux JFLA. \\

	2025 & Arthur~\familyName{Charguéraud}, Martin~\familyName{Bodin}, et Louis~\familyName{Riboulet}, \textit{Typechecking of Overloading in Programming Languages and Mechanized Mathematics}. Aux JFLA. \\

	2024 & Emmanuel~\familyName{Beffara}, Martin~\familyName{Bodin}, et Rémi~\familyName{Molinier}, \textit{Des Tableaux de variation interactifs}. Au Séminaire de l'IREMI. \\

	2024 & Emmanuel~\familyName{Beffara} et Martin~\familyName{Bodin}, \textit{Un jeu de plateau pour comprendre la dualité en logique}. À Adjectif. \\

	2023 & Emmanuel~\familyName{Beffara}, Martin~\familyName{Bodin}, Nadine~\familyName{Mandran}, et Rémi~\familyName{Molinier}, \textit{Instrumentation de l’association de registres sémiotiques dans un assistant de preuve}, À EIAH. \\

	2023 & Jean~\familyName{Abou~Samra}, Martin~\familyName{Bodin}, et Yannick~\familyName{Zakowski}, \textit{Effectful Programming across Heterogeneous Computations — Work in Progress}. Aux JFLA. \\

	2022 & Martin~\familyName{Bodin}, \textit{Les Assistants de preuve : l’exemple de Coq}. Au Séminaire de l'IREM. \\

	2019 & Martin~\familyName{Bodin}, Philippa~\familyName{Gardner}, Thomas~\familyName{Jensen}, et Alan~\familyName{Schmitt}, \textit{Skeletal Semantics}. Au \textit{Verified Software Workshop}. \\
  ...
  2016 & Martin~\familyName{Bodin}, Thomas~\familyName{Jensen}, et Alan~\familyName{Schmitt}. \textit{An Abstract Separation Logic for Interlinked Extensible Records}. Aux JFLA. \\

  2014 & Martin~\familyName{Bodin}, Thomas~\familyName{Jensen}, et Alan~\familyName{Schmitt}. \textit{Certified Abstract Interpretation with Pretty-Big-Step Semantics}. Aux JFLA. \\
  ...
  2013 & Martin~\familyName{Bodin} et Alan~\familyName{Schmitt}. \textit{A Certified JavaScript Interpreter}. Aux JFLA. \\

\end{datecvsection}

\begin{datecvsection}{Autres Publications}

		2025— & Travaux communs du groupe \textit{Informatique de l'école jusqu'au lycée} de l'IREMI de \placeName{Grenoble}. \\

		2024 & Travaux communs du groupe \textit{Raisonnement, Logique, Situations de recherche pour la classe} de l'IREM de \placeName{Grenoble}. \\
...
\begin{datecvsection}{Prises de responsabilité}
		...
		2026 & Membre du comité d'organisation de la conférence Didapro. \\

		2024– & Correspondant local pour le programme \textit{Chiche!} \\

		2024 & Membre du comité de programme pour VSTTE. \\

		2021 & Membre du jury de POPL Student Research Competition. \\
...
%
%		2020 & Rao~\familyName{Xiaojia}, co-encadré avec Philippa~\familyName{Gardner} \\
...
\begin{datecvsection}{Enseignement}
		...
		2024–2025 & Langage et traducteurs, Programmation Fonctionnelle. Travaux dirigés de M1 à \placeName{Polytech Grenoble}. \\

		2021–2023 & Théorie des langages. Travaux dirigés de L3 à \placeName{Grenoble INP}. \\
		2021–2026 & Modèles de calculs. Travaux dirigés de L3 à l’\placeName{UGA}. \\
		2021–2022 & Projet génie logiciel. Projet de M1 à l’\placeName{ENSIMAG}. \\
...
%
%	\item Bon niveau dans les langages de programmation suivants~:  Rocq, OCaml, JavaScript, \LaTeX, etc.
